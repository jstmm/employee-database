...
int remove_employee(struct dbheader_t*, struct employee_t*, const char* employee_index);
int search_employee(struct dbheader_t*, struct employee_t*, const char* search);
